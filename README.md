...
## Présentation
Vous pouvez tester le programme ici : <br/>
https://phiusanthonyus-p7-grandpybot.herokuapp.com/
...
* Le programme utilise les API de Google Maps et de Media Wiki.
* Rien n'est sauvegardé. Si l'utilisateur charge de nouveau la page, tout l'historique est perdu.

## Prérequis
L'utilisateur doit entrer sa clé API fournie par Google dans le fichier "config.cfg" pour pouvoir utiliser le programme de manière optimale.