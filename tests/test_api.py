...
def test_api_wikipedia(monkeypatch):
    ...
    assert api_wk.api_wikipedia_url == "https://fr.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro=&explaintext=&titles=Toulouse"
...
def test_api_googlemaps(monkeypatch):
    ...
    assert api_gm.api_googlemaps_url == "https://maps.googleapis.com/maps/api/geocode/json?address" \
                                        "=OpenClassrooms_Paris&key=AIzaSyAkmHpMq2iqx_Em1tP0P6tmA-wS3ePNaWM&region=fr "
